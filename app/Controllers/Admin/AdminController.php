...
final class AdminController extends Controller
{
    public function index(Request $req): void
    {
        ...
        $this->view('admin/index', [
            ...
            'supp_added_24h'   => (int)($stats['summary']['added_24h'] ?? 0),
            'supp_added_7d'    => (int)($stats['summary']['added_7d'] ?? 0),
            'supp_seen_24h'    => (int)($stats['summary']['seen_24h'] ?? 0),
            'supp_seen_7d'     => (int)($stats['summary']['seen_7d'] ?? 0),
